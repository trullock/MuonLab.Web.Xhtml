...
namespace MustardBlack.Html.Forms
{
	...
	{
		/// <inheritdoc />
		public ConcurrentDictionary<LambdaExpression, string> Entries { get; } = new ConcurrentDictionary<LambdaExpression, string>(LambdaExpressionComparer.Instance);
		...
		class LambdaExpressionComparer : IEqualityComparer<LambdaExpression>
		{
