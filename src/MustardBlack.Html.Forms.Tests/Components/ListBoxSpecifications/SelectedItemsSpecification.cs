...
{
	public class SelectedItemsSpecification : ListBoxComponentSpecification
	{
		Guid item1;
		...
		{
			component.WithValue(new[] {item1});
		}

		protected override IEnumerable<Guid> Items => new [] { item1, Guid.Parse("1A3521DF-8B2B-4AC5-A624-9D819A1F3CBD")};
